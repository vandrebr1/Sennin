...
namespace Sennin.API.Controllers
{
    ...
    [ApiController]
    [Route("v1/[Controller]")]
    public class ProdutoMovimentacaoController : ControllerBase
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IRepository<ProdutoMovimentacao> repository;
        public ProdutoMovimentacaoController([FromServices] IUnitOfWork unitOfWork, [FromServices] IRepository<ProdutoMovimentacao> repository)
        {
        ...
        [HttpGet("")]
        public async Task<ActionResult<IEnumerable<ProdutoMovimentacao>>> Get()
        {
        ...
        public async Task<IActionResult> Post([FromBody] ProdutoMovimentacao model)
        {
        ...
        [SwaggerResponse(400, "Campos inválidas")]
        public async Task<IActionResult> Put([FromBody] ProdutoMovimentacao model)
        {
